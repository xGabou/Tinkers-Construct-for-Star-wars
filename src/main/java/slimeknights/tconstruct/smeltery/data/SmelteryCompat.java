...
public enum SmelteryCompat {
  ...
  NICKEL  (TinkerFluids.moltenNickel,   CompatType.ORE, MaterialIds.nickel),
  ZINC    (TinkerFluids.moltenZinc,     CompatType.ORE),
  PLATINUM(TinkerFluids.moltenPlatinum, CompatType.ORE, MaterialIds.platinum),
  TUNGSTEN(TinkerFluids.moltenTungsten, CompatType.ORE),
  OSMIUM  (TinkerFluids.moltenOsmium,   CompatType.ORE, MaterialIds.osmium),
  URANIUM (TinkerFluids.moltenUranium,  CompatType.ORE, MaterialIds.uranium),
  CHROMIUM(TinkerFluids.moltenChromium, CompatType.ORE, MaterialIds.chromium),
  CADMIUM (TinkerFluids.moltenCadmium,  CompatType.ORE),
  // alloys
  BRONZE    (TinkerFluids.moltenBronze,     CompatType.ALLOY, MaterialIds.bronze),
  BRASS     (TinkerFluids.moltenBrass,      CompatType.ALLOY, MaterialIds.brass),
